    ...
    useEffect(() => {
        ...
        const makeData = (items) => {
            const arr = items.reduce((acc, cur) => {
                ...
                if (!findItem) {
                    acc.push({
                        year: year, month, date, confiremd, active, death, recovered
                    })
                }
                ...
                datasets: [
                    {
                        ...
                        backgroundColor: ["#ff3d37", "#059bff", "#ffc233"],
                        borderColor: ["#ff3d37", "#059bff", "#ffc233"],
                        fill: false,
